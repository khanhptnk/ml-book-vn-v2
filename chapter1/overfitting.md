...
![](/assets/Overly-complicated-hypothesis.png)
...
![](/assets/Noisy-data-complicate-relationship.png)
...
![](/assets/Noisy-data-at-testing-1.png)
...
_Giả sử ta có một phân bố xác suất về sấp ngửa của một đồng xu như sau: 60% ngửa và 40% sấp. Muốn lấy một mẫu từ phân bố này, ta ngẫu nhiên chọn một số thực trong đoạn $\[0, 1\)$, tạm gọi là _$$r$$_. Nếu _$$r \leq 0.6$$_, ta chọn mẫu là ngửa, ngược lại ta chọn mẫu là sấp. Lặp lại quá trình này vô hạn lần, ta được một tập dữ liệu vô hạn gồm các mẫu sấp/ngửa._
